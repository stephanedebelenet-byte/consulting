...
**Une direction financière ne rejette presque jamais un projet IA pour des raisons technologiques.** Elle le rejette quand le business case présenté manque de rigueur — hypothèses non sourcées, absence d'analyse de sensibilité, coûts cachés qui ressortent trop tard dans la discussion. Le modèle financier qui convainc n'est d'ailleurs pas toujours le plus optimiste ; c'est presque toujours le plus robuste face aux questions difficiles. Voici la structure qui tient la route.

Les coûts complets d'abord : licence ou développement, intégration, formation, maintenance sur trois ans, pas seulement l'année un qui masque souvent le vrai coût total. Les gains doivent ensuite être chiffrés sur une baseline mesurée — jamais une estimation sans point de départ documenté, voir notre [méthode de mesure du ROI](/blog/mesurer-le-roi-de-lia-en-supply-chain-les-kpi-qui-comptent). Vient l'analyse de sensibilité : que devient le ROI si le gain réel n'atteint que la moitié de l'hypothèse centrale ? Et enfin le délai de retour, exprimé en mois, comparable directement aux autres investissements que l'entreprise a l'habitude d'arbitrer.
...
Un business case IA qui convainc une direction financière repose sur des coûts complets sur trois ans, des gains chiffrés sur baseline mesurée, et une analyse de sensibilité qui résiste à un scénario pessimiste réaliste. C'est la rigueur du modèle, presque toujours, plutôt que l'ambition du chiffre, qui finit par obtenir la validation.
