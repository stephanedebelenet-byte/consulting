---
title: "Risque de Change pour Importateurs Marocains : se Couvrir"
date: "2026-09-25"
author: "Youssef Bahaida"
schema: "Article"
image: "/images/business.webp"
keywords: "risque de change importateur Maroc, couverture de change, achat à terme devises, dirham euro dollar, gestion risque change PME"
description: "Importateurs marocains : comment le risque de change euro-dollar pèse sur vos marges et quelles couvertures utiliser, du terme aux clauses contractuelles."
---
...
::stat:: 3 à 6 mois — décalage fréquent entre commande et paiement sur une importation d'Asie, pendant lequel le change peut bouger

## Mesurer son exposition

Avant de se couvrir, il faut savoir ce qu'on couvre. Un tableau simple :

| Commande | Devise | Montant | Date de paiement prévue | Couvert ? |
|---|---|---|---|---|
| Fournisseur A | USD | ... | ... | Non |
| Fournisseur B | EUR | ... | ... | Oui (terme) |
...
Le risque de change est proportionnel au délai entre commande et paiement. Réduire le délai d'approvisionnement, c'est aussi réduire l'exposition. C'est un argument supplémentaire pour les approvisionnements plus proches : voir [le sourcing en Turquie ou en Égypte](/blog/sourcing-en-turquie-ou-en-egypte-les-alternatives-proches). Et c'est une raison de plus pour bien connaître ses délais réels : voir [le lead time fournisseur](/blog/lead-time-fournisseur-decomposer-le-delai-pour-le-reduire).

## Ce qu'il faut retenir

Le risque de change naît du décalage entre la commande et le paiement. Le mesurer est la première étape ; l'achat à terme est l'outil le plus simple pour le neutraliser ; une règle écrite évite les décisions au feeling. Pour le cadre général, voir notre article pilier sur [les délais de paiement au Maroc](/blog/delais-de-paiement-au-maroc-loi-69-21-le-guide-pratique) et, pour les techniques de paiement, [le crédit documentaire](/blog/credit-documentaire-fonctionnement-et-pieges-a-eviter).

Vous voulez intégrer le risque de change dans vos décisions d'achat ? [Contactez-nous](/contact).
