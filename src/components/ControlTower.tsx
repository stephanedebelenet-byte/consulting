...
/* ─── Offre Control Tower (3 paliers — mêmes chiffres que Systemes.tsx) ── */
...
const OFFER_TIERS = [
  ...
  { name: 'Control Tower Pro', price: 'À partir de 280 000 MAD HT', duration: '4 à 6 mois', desc: 'ETI · multi-sites · IA/ML · portail mobile dirigeant' },
]
